...
def train_step(model, optimizer, images, labels):
    ...
    # Record the operations used to compute the loss, so that the graident
...
def train(model, optimizer, dataset, log_freq=50):
    ...
    # result when you call .result(). Clear accumulated values with .reset_state()
...
def test(model, dataset, stepnum):
    """
